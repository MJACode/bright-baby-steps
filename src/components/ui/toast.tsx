...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      // On mobile the viewport is pinned to top-0, which on viewport-fit=cover
      // sits *behind* the status bar / notch and clips the toast title. Add the
      // safe-area inset to the top padding so the toast clears it. Desktop
      // toasts sit at the bottom (sm:), so reset the extra padding there.
