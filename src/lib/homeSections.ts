...
export const QUICK_TILES: QuickTile[] = [
  ...
  { id: "financial", label: "Financial", hint: "Checklist & records", icon: DollarSign, path: "/dashboard/financial", tile: "bg-finance-bg", chip: "bg-finance/15 text-finance", labelColor: "text-finance", dot: "bg-finance" },
  ...
  { id: "records", label: "Records", hint: "New Baby, medical, financial, EI", icon: FileText, path: "/dashboard/records", tile: "bg-primary/10", chip: "bg-primary/15 text-primary", labelColor: "text-primary", dot: "bg-primary" },
