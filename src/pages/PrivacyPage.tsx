      ...
      <div className="space-y-6 text-sm leading-relaxed text-foreground/80">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li><strong>AI memory:</strong> short factual notes about your child that our AI assistants save from your chats, briefings, and weekly insights (or that you add yourself) — for example routines, preferences, and things you're working on. You can view, edit, and delete these notes at any time in Profile → About your child.</li>
        ...
        <section>
          ...
          <p>Grace Flare uses <strong>Anthropic, PBC</strong> as its AI service provider to power chat responses, daily briefings, weekly insights, voice-note transcription parsing, suggested pediatrician-visit questions (Visit Prep), and (for Flare+ subscribers) guided weekly speech-practice plans (Speech Class) and weekly activity plans (Weekly Play Plan). The data transmitted to Anthropic depends on the feature: for chat, briefings, and insights, we send your child's first name, age, the relevant logged activity needed to answer your prompt, any interests and temperament you selected, and the saved AI-memory notes described in § 2; for voice-note parsing, we send the transcript of the note you record; for Visit Prep, we send your child's first name, age and prematurity status, the visit date and type you entered, 30-day summaries of your sleep, feeding, and diaper logs, recent temperature readings, illness and growth records, open milestone topics, the questions already on your visit reminder list, and saved notes about your child; for Speech Class, we send your child's first name, age (and corrected age if premature), and up to 30 of the most recent words or sounds you have logged in the Word &amp; Sound Journal; and for the Weekly Play Plan, we send your child's first name, age (and corrected age if premature), any interests and temperament you selected, and the titles of curated activities you have recently marked as tried.</p>
        ...
        <section>
          ...
          <p>We retain your data while your account is active. When you delete your account or a child's record, primary database records are removed within <strong>7 days</strong>. Files in object storage are deleted within <strong>30 days</strong>. Encrypted database backups containing the data are overwritten on our standard backup-rotation cycle (no longer than 30 days) and are accessed during that window only for disaster-recovery purposes. AI-provider logs at Anthropic are deleted on the schedule described in § 4 (a limited period for safety and abuse review under Anthropic's then-current Usage Policy). Aggregated, de-identified statistics that contain no personal information may be retained indefinitely.</p>
