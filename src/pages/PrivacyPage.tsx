    ...
    <div className="min-h-screen bg-background px-4 py-8 max-w-2xl mx-auto">
      ...
      <div className="space-y-1 mb-6">
        ...
        <p className="text-xs text-muted-foreground">
          Effective: June 20, 2026 · Last reviewed: August 29, 2026 ·{" "}
      ...
      <div className="space-y-6 text-sm leading-relaxed text-foreground/80">
        ...
        <section>
          ...
          <p>Grace Flare uses <strong>Anthropic, PBC</strong> as its AI service provider to power daily briefings, weekly insights, home-screen Next Step suggestions, speech-development insights in the Word Journal, suggested pediatrician-visit questions (Visit Prep), and (for Flare+ subscribers) guided weekly speech-practice plans (Speech Class) and weekly activity plans (Weekly Play Plan). The data transmitted to Anthropic depends on the feature: for briefings, weekly insights, and Next Step suggestions, we send your child's first name, age, the relevant logged activity, any interests and temperament you selected, and the saved AI-memory notes described in § 2; for Word Journal insights, we send your child's first name, age, and up to 30 of the most recently logged words; for Visit Prep, we send your child's first name, age and prematurity status, the visit date and type you entered, 30-day summaries of your sleep, feeding, and diaper logs, recent temperature readings, illness and growth records, open milestone topics, the questions already on your visit reminder list, and saved notes about your child; for Speech Class, we send your child's first name, age (and corrected age if premature), and up to 30 of the most recent words you have logged in the Word Journal; and for the Weekly Play Plan, we send your child's first name, age (and corrected age if premature), any interests and temperament you selected, and the titles of curated activities you have recently marked as tried.</p>
