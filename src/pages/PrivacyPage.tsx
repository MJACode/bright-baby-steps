    ...
    <div className="min-h-screen bg-background px-4 py-8 max-w-2xl mx-auto">
      ...
      <div className="space-y-6 text-sm leading-relaxed text-foreground/80">
        ...
        <section>
          ...
          <p>Grace Flare uses <strong>Anthropic, PBC</strong> as its AI service provider to power chat responses, daily briefings, weekly insights, voice-note transcription parsing, and (for Flare+ subscribers who use Speech Class) guided weekly speech-practice plans. The data transmitted to Anthropic depends on the feature: for chat, briefings, and insights, we send your child's first name, age, and the relevant logged activity needed to answer your prompt; for voice-note parsing, we send the transcript of the note you record; for Speech Class, we send your child's first name, age (and corrected age if premature), and up to 30 of the most recent words or sounds you have logged in the Word &amp; Sound Journal.</p>
