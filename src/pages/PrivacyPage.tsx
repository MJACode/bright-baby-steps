    ...
    <div className="min-h-screen bg-background px-4 py-8 max-w-2xl mx-auto">
      ...
      <div className="space-y-6 text-sm leading-relaxed text-foreground/80">
        ...
        <section>
          ...
          <p className="mt-2">Separately, Grace Flare offers an <strong>optional "Connect to Claude" integration</strong> (using the Model Context Protocol). When you turn it on, your own Claude (Claude.ai or Claude Desktop) can read your child's logs over an authenticated connection you explicitly grant. Data that flows through this integration goes to Anthropic under the same Data Processing Addendum that governs our own processing; however, because you are connecting <strong>your own</strong> Claude product, that downstream use is governed by your separate relationship and agreement with Anthropic. You control and can revoke this connection at any time at Settings → Connect to Claude.</p>
        </section>
