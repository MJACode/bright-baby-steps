...
const SUBPROCESSORS: Subprocessor[] = [
  {
    ...
    dataCategories: "All account, child profile, tracking, saved chat history, and technical data described in Privacy Policy § 2.",
    ...
    <div className="min-h-screen bg-background px-4 py-8 max-w-2xl mx-auto">
      ...
      <div className="space-y-1 mb-6">
        ...
        <p className="text-xs text-muted-foreground">
          Effective: May 8, 2026 · Last reviewed: September 7, 2026
        </p>
      </div>
