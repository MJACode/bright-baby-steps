...
- **Anthropic DPA execution** — once executed, verify (a) no-training, (b) ≤30-day abuse-monitoring, (c) SCCs (2021/914), (d) breach ≤72h all match PrivacyPage § 4. Re-issue § 4 with the firmer "we have a written DPA" framing. Store the executed PDF outside the repo (1Password / Google Drive). Update the log.
