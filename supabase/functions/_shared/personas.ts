// Canonical system prompts for Grace Flare's expert chat personas.
// Single source of truth: imported by `supabase/functions/chat/index.ts` for the
// in-app chat, and referenced by `.claude/agents/<persona>.md` so dev-side
// advice stays in sync with what parents actually see.
