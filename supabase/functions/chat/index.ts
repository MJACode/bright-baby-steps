    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `You are a warm, supportive parenting assistant for Baby Steps, a baby tracking app. You help parents with questions about infant sleep, feeding, diapers, milestones, and general baby care.
